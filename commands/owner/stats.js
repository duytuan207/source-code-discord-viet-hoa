...
//command
  if(message.author.id != 682981714523586606){
    ...
    .setDescription("<:astroz_wrong:825598313499459605> Lệnh này chỉ được sử dụng bởi chủ sở hữu của tôi **Nguyễn Mạnh Khoa ")
    .setColor("YELLOW");
...
.setTitle(`**[Hỗ trợ server]**`)
  ...
  .addFields(
    ...
    { name: "<a:Owner:822760998938869760> Bot Owner:",value: `\`\`\`Nguyễn Mạnh Khoa\`\`\``},
  )
  .setColor("3498DB")
